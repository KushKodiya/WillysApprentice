...
public class ModEntry : Mod
{
    ...
    public override void Entry(IModHelper helper)
    {
        ...
        _store = new DataStore(Path.Combine(helper.DirectoryPath, "data"));
        Monitor.Log($"Wiki data loaded: {_store.Count} items.", LogLevel.Info);
    ...
    private void OnButtonPressed(object? sender, ButtonPressedEventArgs e)
    {
        ...
        _panel.ShowItem(_store.Get(_hoveredId));
    }
